...
public class RoundedDrawable extends Drawable {
    ...
    private void redrawBitmapForSquareCorners(Canvas canvas) {
        ...
        if (!mCornersRounded[com.pearl.about.extras.Corner.TOP_LEFT]) {
            mSquareCornersRect.set(left, top, left + radius, top + radius);
            canvas.drawRect(mSquareCornersRect, mBitmapPaint);
        }

        if (!mCornersRounded[com.pearl.about.extras.Corner.TOP_RIGHT]) {
            mSquareCornersRect.set(right - radius, top, right, radius);
            canvas.drawRect(mSquareCornersRect, mBitmapPaint);
        }

        if (!mCornersRounded[com.pearl.about.extras.Corner.BOTTOM_RIGHT]) {
            mSquareCornersRect.set(right - radius, bottom - radius, right, bottom);
            canvas.drawRect(mSquareCornersRect, mBitmapPaint);
        }

        if (!mCornersRounded[com.pearl.about.extras.Corner.BOTTOM_LEFT]) {
     ...
     * @return the {@link RoundedDrawable} for chaining.
     */
    public RoundedDrawable setCornerRadius(@com.pearl.about.extras.Corner int corner, float radius) {
    ...
    public RoundedDrawable setCornerRadius(float topLeft, float topRight, float bottomRight,
        ...
        mCornersRounded[com.pearl.about.extras.Corner.TOP_LEFT] = topLeft > 0;
        mCornersRounded[com.pearl.about.extras.Corner.TOP_RIGHT] = topRight > 0;
        mCornersRounded[com.pearl.about.extras.Corner.BOTTOM_RIGHT] = bottomRight > 0;
        mCornersRounded[com.pearl.about.extras.Corner.BOTTOM_LEFT] = bottomLeft > 0;
        return this;
    }
