...
public class RoundedImageView extends ImageView {
    ...
    private ColorStateList mBorderColor =
            ColorStateList.valueOf(com.pearl.about.extras.RoundedDrawable.DEFAULT_BORDER_COLOR);
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mBorderColor == null) {
            mBorderColor = ColorStateList.valueOf(com.pearl.about.extras.RoundedDrawable.DEFAULT_BORDER_COLOR);
        }
    ...
    public void setImageDrawable(Drawable drawable) {
        mResource = 0;
        mDrawable = com.pearl.about.extras.RoundedDrawable.fromDrawable(drawable);
        updateDrawableAttrs();
    ...
    public void setImageBitmap(Bitmap bm) {
        mResource = 0;
        mDrawable = com.pearl.about.extras.RoundedDrawable.fromBitmap(bm);
        updateDrawableAttrs();
        super.setImageDrawable(mDrawable);
    }
    ...
    private Drawable resolveResource() {
        ...
        return com.pearl.about.extras.RoundedDrawable.fromDrawable(d);
    }
    ...
    private void updateBackgroundDrawableAttrs(boolean convert) {
        if (mMutateBackground) {
            if (convert) {
                mBackgroundDrawable = com.pearl.about.extras.RoundedDrawable.fromDrawable(mBackgroundDrawable);
            }
    ...
    private void updateAttrs(Drawable drawable) {
        ...
        if (drawable instanceof com.pearl.about.extras.RoundedDrawable) {
            ((com.pearl.about.extras.RoundedDrawable) drawable)
            ...
            if (mCornerRadii != null) {
                ((com.pearl.about.extras.RoundedDrawable) drawable).setCornerRadius(
                        mCornerRadii[com.pearl.about.extras.Corner.TOP_LEFT],
                        mCornerRadii[com.pearl.about.extras.Corner.TOP_RIGHT],
                        mCornerRadii[com.pearl.about.extras.Corner.BOTTOM_RIGHT],
                        mCornerRadii[com.pearl.about.extras.Corner.BOTTOM_LEFT]);
     ...
     * @return the radius.
     */
    public float getCornerRadius(@com.pearl.about.extras.Corner int corner) {
     ...
     */
    public void setCornerRadiusDimen(@com.pearl.about.extras.Corner int corner, @DimenRes int resId) {
     ...
     */
    public void setCornerRadius(@com.pearl.about.extras.Corner int corner, float radius) {
    ...
    public void setCornerRadius(float topLeft, float topRight, float bottomLeft, float bottomRight) {
        if (mCornerRadii[com.pearl.about.extras.Corner.TOP_LEFT] == topLeft
                && mCornerRadii[com.pearl.about.extras.Corner.TOP_RIGHT] == topRight
                && mCornerRadii[com.pearl.about.extras.Corner.BOTTOM_RIGHT] == bottomRight
                && mCornerRadii[com.pearl.about.extras.Corner.BOTTOM_LEFT] == bottomLeft) {
            return;
        }

        mCornerRadii[com.pearl.about.extras.Corner.TOP_LEFT] = topLeft;
        mCornerRadii[com.pearl.about.extras.Corner.TOP_RIGHT] = topRight;
        mCornerRadii[com.pearl.about.extras.Corner.BOTTOM_LEFT] = bottomLeft;
        mCornerRadii[com.pearl.about.extras.Corner.BOTTOM_RIGHT] = bottomRight;
    ...
    public void setBorderColor(ColorStateList colors) {
        ...
        mBorderColor =
                (colors != null) ? colors : ColorStateList.valueOf(com.pearl.about.extras.RoundedDrawable.DEFAULT_BORDER_COLOR);
        updateDrawableAttrs();
        updateBackgroundDrawableAttrs(false);
        if (mBorderWidth > 0) {
            invalidate();
